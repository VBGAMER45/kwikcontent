...
if ($domain->yahoo_app_id == 'YahooDemo') {
	$yahoo_app_id_alert = 'Your software is currently using Yahoo\'s demo application ID.  Although this will allow you to update your Yahoo Answers, you will need to store your own Yahoo! Application ID in order for your kwikcontent software to work properly.  <a href="http://search.yahooapis.com/webservices/register_application" target="_blank">Get one here</a>.';
}
// Check for Bing
if ($domain->bing_app_id == '') {
	$yahoo_app_id_alert .= 'You need to store your Bing Application ID in order for your kwikcontent software to work properly.  <a href="http://www.bing.com/developers/createapp.aspx" target="_blank">Get one here</a>.';
}
