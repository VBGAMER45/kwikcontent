...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
	...
	$result = mysql_query("SELECT id, domain, date, hits, removed FROM sites ORDER BY domain");

	while ($row = mysql_fetch_assoc($result))
	{
	echo '
	<tr>
		<td class="tableRowRightd" align="center"><a href="http://' . $row['domain'] . '">' . $row['domain'] . '</a>&nbsp;(<a href="http://' . $row['domain'] . '/admin/">Manage</a>)</td>
